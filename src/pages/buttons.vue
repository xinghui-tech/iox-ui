...
<block>
  ...
  <demo-block title="图标按钮" padding>
    <iox-button type="primary" icon="bell" class="demo-margin-right" />
    <iox-button type="primary" icon="bell" class="demo-margin-right">按钮</iox-button>
